...
add_bool_arg(parser,'train_volume',default=False) # train on cell volume
add_bool_arg(parser,'train_flow', default=False) # train normalizing flow generator via flow loss
add_bool_arg(parser,'gan_adversarial_loss',default=False) # train generator on adversarially

# data in modelling
parser.add_argument('--d_g_balance', type=float, default=0.5)
