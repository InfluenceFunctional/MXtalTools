...
from crystal_building.utils import align_crystaldata_to_principal_axes
from reporting.online import swarm_vs_tgt_fig, decoder_swarm_clustering
...
def converging_gaussians_fig():
    ...
    for flat_ind in [980]:  # , 20, 28, 53, 95]:
        ...
        for ind, (sigma, noise) in enumerate(zip(sigmas, noises)):
            ...
            rmsd, max_dist, weight_mean = decoder_swarm_clustering(0, scaled_data, decoded_data,
