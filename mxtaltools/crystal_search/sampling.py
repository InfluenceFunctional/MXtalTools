...
class Sampler:
    ...
    def _random_MC_step(self, mol_data, prior, step_size_tensor):
        ...
        raw_samples = mxtaltools.crystal_search.standalone_crystal_opt.cleanup_sample(raw_samples, mol_data.sg_ind)
...
'''
    ...
    def _gd_opt_step(self, hit_max_lr, lr_record, max_lr, mol_batch, optimizer, s_ind, sample, scheduler1, scheduler2,
                     score_func, standardize_pose):
        optimizer.zero_grad()
        cleaned_sample = cleanup_sample(sample, mol_batch.sg_ind, self.supercell_builder.symmetries_dict)
