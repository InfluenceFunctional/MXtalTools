...
class CrystalData(BaseData):
    ...
    def __init__(self,
                 ...
                 cell_lengths: OptTensor = None,
                 cell_angles: OptTensor = None,
                 z_prime: int = 0,
                 ...
                 skinny_init: bool = False,
                 **kwargs):
        super().__init__()
        self.__dict__['_store'] = GlobalStorage(_parent=self)

        # todo add flag for cheap initialization
        ...
        if pos is not None:
            self.pos = pos
            if self.radius is None and not skinny_init:
        ...
        if require_crystal_features:
            ...
            if cell_lengths is None:
                ...
                self.T_cf, _ = (
                    cell_parameters_to_box_vectors('c_to_f', cell_lengths, cell_angles, return_vol=True))
