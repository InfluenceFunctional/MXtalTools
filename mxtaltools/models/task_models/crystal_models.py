...
from mxtaltools.models.graph_models.molecule_graph_model import MoleculeGraphModel, MolecularCrystalGraphModel
import torch
...
class MolCrystal2(BaseGraphModel):
    def __init__(self, seed, config,
                 atom_features: list,
                 molecule_features: list,
                 output_dim: int,
        ...
        wrapper for molecule model, with appropriate I/O
        """
        super(MolCrystal2, self).__init__()
