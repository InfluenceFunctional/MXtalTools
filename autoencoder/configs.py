...
dev = {'run_name': 'dev',
       ...
       'decoder_num_nodewise_fcs': 4,
       'decoder_graph_norm': 'graph layer',
...
for i in range(num_tests):
    ...
    for ind, (key, values) in enumerate(search_space.items()):
        if key == 'embedding_depth':
            ...
            new_config['encoder_num_layers'] = values[randints[i, ind]]
            new_config['decoder_num_layers'] = values[randints[i, ind]]
        else:
