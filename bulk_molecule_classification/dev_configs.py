...
dev = {'run_name': 'dev_nic',
       ...
       'train_model': True,
       'trajs_to_analyze_list': [f'D:/crystals_extra/classifier_training/paper_nic_clusters2/{ind}/' for ind in range(12)],
       #[f'D:/crystals_extra/classifier_training/crystal_in_melt_test6/{ind}/' for ind in [0, 1, 2, 3]],
       ...
       'dumps_dirs': ['new_small_bulk'], #['nicotinamide_liq', 'bulk_trajs3'],
       'training_temps': [100, 350],
       'dataset_name': 'small_nic_test', #'nicotinamide_trajectories_dataset_100_350_vf',
