...
dev = {'run_name': 'dev',
       ...
       'train_model': False,
       'trajs_to_analyze_list': [f'D:/crystals_extra/classifier_training/melt_trajs2/{num}/' for num in range(2)] + [f'D:/crystals_extra/defect_clusters_6/{num}/' for num in defect_clusters_6_pure_nic_runs[:3]], # +
       ...
       'classifier_path': 'C:/Users/mikem/crystals/classifier_runs/test3_best_classifier_checkpoint',  # r'C:/Users/mikem/crystals/classifier_runs/test6_best_classifier_checkpoint',
       'learning_rate': 1e-4,
...
config1 = {'run_name': 'test1',
           ...
           'learning_rate': 1e-4,
           'datasets_path': r'/vast/mk8347/molecule_clusters/classifier_training/',
